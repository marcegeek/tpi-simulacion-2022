...
\section{Resultados obtenidos}
    ...
    \begin{figure}[htbp]
        \centering
        \includegraphics{images/esc1/dinamica.jpg}
        \caption{Cantidad de fallecimientos, embarazos y crías en total que se desarrollaron satisfactoriamente en la época de crianza}
        \label{fig:fig1-1}
        ...
        \centering
        \includegraphics{images/esc1/genero.jpg}
        \caption{Cantidad de yaguaretés hembras en comparación con cantidad de machos}
        \label{fig:fig1-2}
        ...
        \centering
        \includegraphics[width=350pt]{images/esc1/densidad.jpg}
        \caption{Cantidad de individuos en el área por año}
        \label{fig:fig1-3}
    \end{figure}
    ...
    \begin{figure}[htbp]
        \centering
        \includegraphics{images/esc2/dinamica.jpg}
        \caption{Cantidad de fallecimientos, embarazos y crías en total que se desarrollaron satisfactoriamente en la época de crianza}
        \label{fig:fig2-1}
        ...
        \centering
        \includegraphics{images/esc2/genero.jpg}
        \caption{Cantidad de yaguaretés hembras en comparación con cantidad de machos}
        \label{fig:fig2-2}
        ...
        \centering
        \includegraphics[width=350pt]{images/esc2/densidad.jpg}
        \caption{Cantidad de individuos en el área por año}
        \label{fig:fig2-3}
    \end{figure}
    ...
    \begin{figure}[htbp]
        \centering
        \includegraphics{images/esc3/dinamica.jpg}
        \caption{Cantidad de fallecimientos, embarazos y crías en total que se desarrollaron satisfactoriamente en la época de crianza}
        \label{fig:fig3-1}
        ...
        \centering
        \includegraphics{images/esc3/genero.jpg}
        \caption{Cantidad de yaguaretés hembras en comparación con cantidad de machos}
        \label{fig:fig3-2}
        ...
        \centering
        \includegraphics[width=350pt]{images/esc3/densidad.jpg}
        \caption{Cantidad de individuos en el área por año}
        \label{fig:fig3-3}
    \end{figure}
