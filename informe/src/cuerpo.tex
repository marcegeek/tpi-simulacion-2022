...
\section{Resultados obtenidos}
    ...
    \begin{figure}[!htb]
        ...
        \includegraphics[width=\linewidth]{images/esc1/dinamica.jpg}
        ...
        \endminipage\hfill
        \minipage{0.32\textwidth}
        \includegraphics[width=\linewidth]{images/esc1/genero.jpg}
        \caption{Cantidad de yaguaretés hembras en comparación con cantidad de machos}\label{fig:fig1-2}
        \endminipage\hfill
        \minipage{0.32\textwidth}
        \includegraphics[width=\linewidth]{images/esc1/densidad.jpg}
    ...
    \begin{figure}[!htb]
        \minipage{0.32\textwidth}
        \includegraphics[width=\linewidth]{images/esc2/dinamica.jpg}
        ...
        \endminipage\hfill
        \minipage{0.32\textwidth}
        \includegraphics[width=\linewidth]{images/esc2/genero.jpg}
        \caption{Cantidad de yaguaretés hembras en comparación con cantidad de machos}\label{fig:fig2-2}
        \endminipage\hfill
        \minipage{0.32\textwidth}
        \includegraphics[width=\linewidth]{images/esc2/densidad.jpg}
    ...
    \begin{figure}[!htb]
        \minipage{0.32\textwidth}
        \includegraphics[width=\linewidth]{images/esc3/dinamica.jpg}
        ...
        \endminipage\hfill
        \minipage{0.32\textwidth}
        \includegraphics[width=\linewidth]{images/esc3/genero.jpg}
        \caption{Cantidad de yaguaretés hembras en comparación con cantidad de machos}\label{fig:fig3-2}
        \endminipage\hfill
        \minipage{0.32\textwidth}
        \includegraphics[width=\linewidth]{images/esc3/densidad.jpg}
